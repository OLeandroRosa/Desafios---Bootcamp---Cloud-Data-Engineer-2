...
retorno = ctypes.windll.kernel32.SetFileAttributesW(pasta,atributo_ocultar) #chama na biblioteca ctype a DLL que  permite o que o arquvo seja manipulado e se torne oculto
